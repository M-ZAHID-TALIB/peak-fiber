...
const DepositRequests = ({ user }) => {
  ...
  // GET /api/deposit-requests -> pending and historical deposit requests
  const fetchDeposits = () => {
  ...
  // GET /api/banks -> list of bank accounts for reconciliation
  const fetchBanks = () => {
  ...
  // POST /api/deposit-requests -> create a deposit request (staff reports bank deposit)
  const handleCreate = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:8000/api/deposit-requests",
        {
          method: "POST",
  ...
  // PUT /api/deposit-requests/{id}/action -> Approve or Reject a deposit (bank admin action)
  const handleAction = async (id, status) => {
    if (!confirm(`Are you sure you want to ${status} this request?`)) return;

    try {
      const response = await fetch(
        `http://localhost:8000/api/deposit-requests/${id}/action`,
        {
          method: "PUT",
          headers: { "Content-Type": "application/json" },
    ...
    <div style={{ padding: "2rem" }}>
      ...
      >
        <div>
          ...
          <p style={{ color: "#64748b", fontSize: "1rem" }}>
            Verify staff deposits against bank entries.
          </p>
        </div>
      ...
      <div style={{ display: "flex", gap: "24px" }}>
                    ...
                    >
                      ...
                      <td style={{ padding: "20px" }}>
                        <div style={{ fontWeight: "600", color: "#334155" }}>
                          {banks.find((b) => b.id === dep.bank_id)?.name ||
                            "Unknown Bank"}
                        </div>
        ...
        <div style={{ width: "300px" }}>
          ...
          >
            <h3
              style={{ margin: "0 0 20px 0", fontSize: "1rem", opacity: 0.8 }}
            >
              Pending Clearance
            </h3>
